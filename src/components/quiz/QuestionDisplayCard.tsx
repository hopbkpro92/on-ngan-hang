          ...
          {question.options.map((option, index) => {
            ...
            if (quizMode === 'learning' && hasBeenAnswered) {
              if (isCorrectAnswer) {
                ...
                icon = <CheckCircle className="mr-2 h-5 w-5 text-correct-answer-foreground" />;
                ...
                icon = <XCircle className="mr-2 h-5 w-5 text-incorrect-answer-foreground" />;
              } else {
            ...
            return (
              ...
              >
                ...
                <span className="text-base flex-grow">{option}</span>
              </Label>
            );
          })}
        </RadioGroup>
         {quizMode === 'learning' && hasBeenAnswered && selectedOption !== question.correctAnswerIndex && (
          <p className="mt-4 p-3 rounded-md bg-correct-answer/20 text-correct-answer-foreground border border-correct-answer text-sm">
